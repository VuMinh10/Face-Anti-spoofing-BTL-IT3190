...
def train():
    ...
    # [ĐÃ SỬA] Xóa src3 khỏi get_dataset
    ...
    for iter_num in range(max_iter+1):
        ...
        # [ĐĐ SỬA] Chỉ nối tensor ảnh của src1 và src2
        ...
        # [ĐÃ SỬA] Chỉ nối feature của src1 và src2
